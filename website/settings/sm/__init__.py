...
DEFAULT_FROM_EMAIL = 'sample SM <test.advisor1@sample.com>'

ALLOWED_HOSTS = [
    'localhost',
    'advisor.sm.sample.com',
    'advisor.maint.sample.com',
    'sf.api.sm.sample.com',
    'cbc.api.sm.sample.com',
    'api.sm.sample.com',
    'box.api.sm.sample.com',
    'task.api.sm.sample.com',
]
...
CORS_ORIGIN_WHITELIST = (
    'myhome.sm.sample.com',
    'myhome.maint.sample.com',
...
RATE_QUOTE_SERVICE_LESS = RATE_QUOTE_SERVICE + '_less'
# Loan sifter
...
SITE_PATH = 'https://api.sm.sample.com'
...
BOX_API_OAUTH_REDIRECT_URL = 'https://box.api.sm.sample.com/callbacks/box/redirect'
...
CELERYBEAT_SCHEDULE = {
    ...
    'sync_unprocessed_box_events': {
        'task': 'box.tasks.sync_unprocessed_box_events',
...
SESSION_COOKIE_NAME = 'maint-sample-session-id'
CSRF_COOKIE_NAME = 'maint-sample-csrftoken'
